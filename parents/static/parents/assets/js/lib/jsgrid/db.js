(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.clients, function(client) {
                return (!filter.Teacher || client.Teacher.indexOf(filter.Teacher) > -1)
                    && (filter.Date === undefined || client.Date === filter.Date)
                    && (!filter.Work || client.Work.indexOf(filter.Work) > -1)
                    && (!filter.Subject || client.Subject === filter.Subject)
                    && (filter.Check === undefined || client.Check === filter.Check);
            });
        },
    ...
    db.clients = [
        
        {
            ...
            "Date": 3,
            "Subject": 7,
            "Work": "Read the topic in 209 page",
            "Check": false
        },
        {
            "Teacher": "Mr. Munna",
            "Date": 29,
            "Subject": 6,
            "Work": "Read the c program chapter",
            "Check": false
        },
        {
            "Teacher": "Mr.Saleh",
            "Date": 4,
            "Subject": 5,
            "Work": "Read the lessson in page 123",
            "Check": false
        },
        {
            "Teacher": "Mr. Subroto",
        ...
        },
        {
            ...
            "Date": 29,
            "Subject": 3,
            "Work": "Practice 3,4,5,6,7,10 in 120 page",
            "Check": false
        },
        {
            "Teacher": "Ms. Adity",
        ...
        },
        {
            ...
            "Date": 3,
            "Subject": 1,
            "Work": "Read the poem in 302 page",
            "Check": false
        }
    ...
    db.users = [
        {
            ...
            "Teacher": "Carson Kelley",
            "RegisterDate": "2002-04-20T22:55:52-07:00"
        },
        {
            "Account": "D89FF524-1233-0CE7-C9E1-56EFF017A321",
            "Teacher": "Prescott Griffin",
            "RegisterDate": "2011-02-22T05:59:55-08:00"
        },
        {
            "Account": "06FAAD9A-5114-08F6-D60C-961B2528B4F0",
            "Teacher": "Amir Saunders",
            "RegisterDate": "2014-08-13T09:17:49-07:00"
        },
        {
            "Account": "EED7653D-7DD9-A722-64A8-36A55ECDBE77",
            "Teacher": "Derek Thornton",
            "RegisterDate": "2012-02-27T01:31:07-08:00"
        },
        {
            "Account": "2A2E6D40-FEBD-C643-A751-9AB4CAF1E2F6",
            "Teacher": "Fletcher Romero",
            "RegisterDate": "2010-06-25T15:49:54-07:00"
        },
        {
            "Account": "3978F8FA-DFF0-DA0E-0A5D-EB9D281A3286",
            "Teacher": "Thaddeus Stein",
        ...
        },
        {
            ...
            "Teacher": "Philip Galloway",
            "RegisterDate": "2008-08-21T18:59:38-07:00"
        },
        {
            "Account": "C196781C-DDCC-AF83-DDC2-CA3E851A47A0",
            "Teacher": "Mason French",
